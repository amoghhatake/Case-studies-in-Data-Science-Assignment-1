"""MLP (Neural Network) on the BAF (Bank Account Fraud) dataset."""
import pandas as pd
...
# MLPClassifier has no class_weight parameter (unlike LogisticRegression),
# so undersampling is used instead to address class imbalance.
